...
public class PrototypeEnemyShooter : MonoBehaviour {

    public PrototypeEnemyBullet bullet;
    ...
    IEnumerator ShootPlayer() {
        while (true) {
            ...
            for (int i = 0; i < Random.Range(minBullets, maxBullets); i++) {
                PrototypeEnemyBullet newEnemyBullet = Instantiate(bullet).GetComponent<PrototypeEnemyBullet>();
